...
Scale_factor = [1,2,3,4,5];

for i = 1:length(Scale_factor)
    xmin = -5*Scale_factor(i);
    xmax = 10*Scale_factor(i);
    ymin = -5*Scale_factor(i);
    ymax = 5*Scale_factor(i);
    x_c = 0;
    y_c = 0;
    r_c = 0.5;
    ...
    for n = 1:Nt
        ...
        fprintf("TS number=%d, (u,v)i=%d, Ptime=%d, conv=%d, div=%d \n",...
    ...
    filename_Force = "Force_coefficient_Re_" + num2str(Re) + "_scale_factor_" + Scale_factor(i) + ".mat";
